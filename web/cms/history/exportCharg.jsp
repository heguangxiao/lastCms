...
<%
    try {
        ...
        list = dao.findAll(phone, stRequest, endRequest, telco, topupId);
...
<%!
    public static void createExcel(ArrayList<HistoryCharg> all, HttpServletResponse response) {
        ...
        try {
            ...
            response.setHeader("Content-Disposition", "attachment; filename=ListChargHistory-" + DateProc.createDDMMYYYY() + ".xlsx");
