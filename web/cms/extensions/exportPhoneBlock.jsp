...
<%
    try {
        ...
        ArrayList<BlockPhone> list = dao.findAll(phonesearch);
...
<%!
    public static void createExcel(ArrayList<BlockPhone> all, HttpServletResponse response) {
        ...
        try {
            ...
            response.setHeader("Content-Disposition", "attachment; filename=ListPhoneBlock-" + DateProc.createDDMMYYYY() + ".xlsx");
